...
def main(config, experiment_name):
    ...
    GetData().qlib_data(target_dir=args.input_data, region=config['qlib_init']['region'], exists_skip=True)
    qlib.init(provider_uri=args.input_data, region=config['qlib_init']['region'])
...
if __name__ == "__main__":
    ...
    args = parse_args()
    configpath = str(Path(__file__).parent.joinpath(args.config_file))
